...
const CustomButton = ({ text, onclick }) => {
  return (
    <button
      onClick={onclick}
      class="group relative inline-block overflow-hidden border-2 border-black dark:border-gray-100 bg-main px-12 py-3 text-xl font-medium text-black dark:text-white hover:text-primary dark:hover:text-primary focus:outline-none hover:border-transparent dark:hover:border-transparent"
    >
